...
import { Grid, Card, IconButton, Typography } from "@mui/material";
import AddCircleOutlineIcon from "@mui/icons-material/AddCircleOutline";
import { useTheme } from "@mui/material/styles";
import { MarketCard } from "../../features/TT/home";
import Box from "@mui/material/Box";
import { useNavigate } from "react-router-dom";
import { getCurrentMarkets } from "../../features/TT/home/service";
  ...
  return (
    ...
    >
      ...
      >
        {getUserRole() === "CP" && (
          <IconButton
            color="secondary" // Utilise la couleur secondaire
            sx={{
              flexDirection: "column",
              textAlign: "center",
              color: theme.palette.secondary.main, // Couleur du texte
            }}
            onClick={() => {
              navigate("CP/CreateNewMarket");
            }}
          >
