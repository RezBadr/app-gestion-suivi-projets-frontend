...
import {
  ...
  NoteDialog,
  ConfirmationDialog,
} from "../../features/CL/agrementDetails";

import { useLocation } from "react-router-dom";

const sampleAgrements = [
  { id: 1, name: "Agrement de bordure 1" },
  { id: 2, name: "Agrement de bordure 2" },
  { id: 3, name: "Agrement de bordure 3" },
  { id: 4, name: "Agrement de bordure 4" },
  { id: 5, name: "Agrement de brodure 5" },
  { id: 1, name: "Agrement de bordure 1" },
  { id: 1, name: "Agrement de bordure 1" },
  { id: 1, name: "Agrement de bordure 1" },
];
