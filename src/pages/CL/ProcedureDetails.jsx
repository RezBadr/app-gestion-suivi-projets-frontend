...
import {
  ...
  NoteDialog,
  ConfirmationDialog,
} from "../../features/CL/procedureDetails";

import { useLocation } from "react-router-dom";

const sampleProcedures = [
  { id: 1, name: "Procedure de bordure 1" },
  { id: 2, name: "Procedure de bordure 2" },
  { id: 3, name: "Procedure de bordure 3" },
  { id: 4, name: "Procedure de bordure 4" },
  { id: 5, name: "Procedure de brodure 5" },
  { id: 1, name: "Procedure de bordure 1" },
  { id: 1, name: "Procedure de bordure 1" },
  { id: 1, name: "Procedure de bordure 1" },
];
